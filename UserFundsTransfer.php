...
<div class="container">
    ...
    if (isset($_POST["transferFunds"])) {
        ...
        $queryFrom = "SELECT money FROM `account_info` WHERE uniqueID = '$fromUniqueID' AND accID = '$userID'";
        ...
        if ($resultFrom && mysqli_num_rows($resultFrom) == 1) {
            ...
            if ($balanceFrom >= $amount && $amount > 0) {
                ...
                $updateQueryFrom = "UPDATE `account_info` SET money = '$newBalanceFrom' WHERE uniqueID = '$fromUniqueID' AND accID = '$userID'";
                ...
                echo "Insufficient balance in the 'From Account' or negative value.";
            }
        } else {
            echo "Invalid 'From Account' ID or unauthorized access.";
        }
    }
?>